...
const Hero = () => {
  return (
    <section
      ...
      className="main-section curmina-flying-balls
particles-js bg-1"
    >
...
curnina-heading heading--h2
heading--width-decoration mb-10 text-body-medium"
            >
              <div className="heading-sup-title text-heading1-bold">
...
heading--half-colored text-body-semibold my-2 text-primary-500 "
              ...
              <div className="heading--text">
                Join us in revolutionizing the real estate industry. Explore our
