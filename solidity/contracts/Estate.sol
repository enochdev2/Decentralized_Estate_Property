...
contract Estate is Ownable, ReentrancyGuard {
  ...
  constructor(uint _taxPercent, uint _securityFee) {
    ...
    // All ABOUT APPARTMENT FUNCTIONS // CREATING, UPDATING, DELETING, RETRIVING ALL APPARTMENT AND RETRIVING SINGLE APPARTMENT
